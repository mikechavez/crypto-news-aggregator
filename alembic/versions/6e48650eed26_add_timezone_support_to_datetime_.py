...
def upgrade() -> None:
    ...
    op.alter_column('alerts', 'price_target',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               nullable=True)
    op.alter_column('alerts', 'threshold_percentage',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               nullable=True)
    ...
    op.alter_column('articles', 'updated_at',
               ...
               type_=sa.DateTime(timezone=True),
               existing_nullable=True)
    op.alter_column('sentiments', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.DateTime(timezone=True),
               existing_nullable=True)
    op.alter_column('sentiments', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.DateTime(timezone=True),
               existing_nullable=True)
    ...
    op.alter_column('trends', 'created_at',
               ...
               type_=sa.DateTime(timezone=True),
               existing_nullable=True)
    op.alter_column('trends', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.DateTime(timezone=True),
               existing_nullable=True)
...
def downgrade() -> None:
    ...
    op.alter_column('articles', 'published_at',
               ...
               type_=postgresql.TIMESTAMP(),
               existing_nullable=True)
    op.add_column('alerts', sa.Column('active', sa.BOOLEAN(), autoincrement=False, nullable=True))
    op.add_column('alerts', sa.Column('triggered_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
