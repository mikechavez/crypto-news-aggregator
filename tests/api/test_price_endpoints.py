...
def mock_price_service():
    ...
    with patch('src.crypto_news_aggregator.api.v1.endpoints.price.get_price_service') as mock:
        yield mock
...
class TestPriceEndpoints:
    ...
    def test_get_current_bitcoin_price_success(self, client, mock_price_service, mock_auth):
    ...
    def test_get_current_bitcoin_price_service_error(self, client, mock_price_service, mock_auth):
    ...
    def test_get_bitcoin_price_history_success(self, client, mock_price_service, mock_auth):
    ...
    def test_get_bitcoin_price_history_invalid_hours(self, client, mock_price_service, mock_auth):
    ...
    def test_get_market_analysis_bitcoin_success(self, client, mock_price_service, mock_auth):
    ...
    def test_get_market_analysis_ethereum_success(self, client, mock_price_service, mock_auth):
    ...
    def test_get_market_analysis_service_error(self, client, mock_price_service, mock_auth):
        """Test market analysis when service fails."""
        mock_service = mock_price_service.return_value
        mock_service.generate_market_analysis_commentary.side_effect = Exception("Service error")
