...
# Test data
POSITIVE_TEXT = (
    "I love this amazing product! It works perfectly and I'm very happy with it."
)
NEGATIVE_TEXT = "This is terrible. I hate how slow and buggy this software is. Worst experience ever."
NEUTRAL_TEXT = (
    "This is a neutral statement. It contains no strong opinions or emotions."
)
...
SENTIMENT_TEST_CASES = [
    (
        ...
        (0.1, 1.0),
        (0.3, 1.0),
    ),  # (text, (min_polarity, max_polarity), (min_subjectivity, max_subjectivity))
...
def test_analyze_text_with_emoji():
    ...
    assert result["label"] in [
        "Positive",
        "Neutral",
    ]  # Allow for neutral as some emojis might not be recognized
