...
class ArticleBase(BaseModel):
    ...
    title: str
    source_id: Optional[str] = Field(None, unique=True, description="The unique ID of the article from its source (e.g., tweet ID).")
    source: Literal["twitter", "telegram", "rss", "reddit", "chaingpt"] = Field(..., description="The source of the article.")
    text: str
